"""Sentence-level chunking for circulars and statutory text.

Pure-function module — no database, no ML imports. Safe to import in tests
that run without sqlalchemy or sentence-transformers.
"""
