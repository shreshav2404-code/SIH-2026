...
Say "  rana / demo1234      Mine Manager"
Say "  khadir / demo1234    Safety Officer"
Say "  nisarga / demo1234   Regulator"
Say ""
Say "  All five are on the same mine with the same access. The role is a job"
Say "  title, not a permission level - see DEMO_WRITERS in api/auth.py."
Say ""
